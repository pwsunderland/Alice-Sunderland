...
import sunderland.leapmotion.KeyTapNavigationListener;
...
public class LeapMotionKeyTapNavigationBehavior extends	InternalResponseBehavior {
	...
	private KeyTapNavigationListener keyTapNavigationListener = new KeyTapNavigationListener(this, controller);
	...
	public void started(World world, double time) {
		controller.addListener(keyTapNavigationListener);
...
//			((KeyMapping)keyMap.get()).cleanState();
	...
	public void stopped(World world, double time) {
		controller.removeListener(keyTapNavigationListener);
